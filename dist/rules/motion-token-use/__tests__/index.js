...
testRule(_["default"], {
  ...
  accept: [{
    ...
    description: "Accept $varaible declared before use with Carbon motion tokens."
  }, {
...
testRule(_["default"], {
  ...
  reject: [// an ibm motion token
  {
    code: ".foo { transition: all $my-value-reject; }",
    description: "Reject undeclared $variable for transittion when acceptUndefinedVariables is false."
  }, {
